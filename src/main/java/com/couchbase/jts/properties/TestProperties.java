...
public class TestProperties {
    ...
    public static final String CBSPEC_KEYSTORE_FILE = "couchbase_keystore_file";
    private static final String CBSPEC_KEYSTORE_FILE_DEFAULT = "";

    public static final String CBSPEC_KEYSTORE_PASSWORD = "couchbase_keystore_pass";
    private static final String CBSPEC_KEYSTORE_PASSWORD_DEFAULT = "";
    ...
    public TestProperties(String[] args) {
        ...
        options.addOption(Option.builder(CBSPEC_KEYSTORE_FILE).hasArg().required(false).build());
        options.addOption(Option.builder(CBSPEC_KEYSTORE_PASSWORD).hasArg().required(false).build());
        ...
        prop.put(CBSPEC_KEYSTORE_FILE, cmd.getOptionValue(CBSPEC_KEYSTORE_FILE, CBSPEC_KEYSTORE_FILE_DEFAULT));
        prop.put(CBSPEC_KEYSTORE_PASSWORD, cmd.getOptionValue(CBSPEC_KEYSTORE_PASSWORD, CBSPEC_KEYSTORE_PASSWORD_DEFAULT));
